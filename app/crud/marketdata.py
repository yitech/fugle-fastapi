...
from app.schema.fuglemarket import QuoteResponse, KLinesResponse
...
def get_historical_candles(market: MarketSingleton, symbol: str, from_date: str, to_date: str, resolution: str="D") -> KLinesResponse:
